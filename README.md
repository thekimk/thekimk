...
## ✋ Direction 
- **[수업방식]:** 대학원은 모두 `오프라인`으로 진행하고, 대학은 `온라인+오프라인 혼합형`으로 전체 수업중 `8주는 온라인`으로 `7주는 오프라인`으로 진행    
- **[강의영상]:** 오프라인 및 온라인으로 진행되는 `모든 강의영상`은 LMS에 업로드    
- **[강의진행]:** 대학원은 `(2)`의 방식으로 진행하고, 대학은 `(1)+(2)`의 방식으로 진행    
>
