...
| **`비즈니스수요예측`** <br> **`(Business Forecasting)`** | [선수과목] `디지털비즈니스애널리틱스` <br> [이론1 & 실습] [All-About-Machine-Learning](https://github.com/thekimk/All-About-Machine-Learning) <br> [이론2 & 실습] [All-About-Machine-Learning](https://github.com/thekimk/Business-Data-Analytics) |
